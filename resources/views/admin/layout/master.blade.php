        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="index.html"><i class="menu-icon fa fa-laptop"></i>{{ trans('message.Dashboard')}}</a>
                    </li>
                    <li class="menu-title">{{ trans('message.List')}}</li><!-- /.menu-title -->
                    ...
                    <li class="menu-item-has-children dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>{{ trans('message.user')}}</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="{{ route('users.index')}}">{{ trans('message.listUser')}}</a></li>
                        </ul>
                    </li>
                    <li class="menu-item-has-children dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-table"></i>{{ trans('message.order')}}</a>
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-table"></i><a href="{{ route('order.index') }}">{{ trans('message.listorder')}}</a></li>
                        </ul>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
                    ...
                    <div class="header-left">
                        ...
                        <div class="dropdown for-notification">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="notification" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <span class="count bg-danger">99</span>
                            </button>
                            <div class="dropdown-menu" aria-labelledby="notification">
                                <p class="red">{{ __('message.You have 3 Notification')}}</p>
            ...
            <div class="footer-inner bg-white">
                <div class="row">
                    ...
                    <div class="col-sm-6 text-right">
                        Designed by <a href="https://colorlib.com">Huân And Hoàng</a>
                    </div>
                </div>
            </div>
        </footer>
